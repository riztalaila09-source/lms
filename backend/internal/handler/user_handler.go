...
func (h *UserHandler) CreateUser(
	...
	u, err := h.userSvc.CreateUser(ctx, claims.Role, req.Msg.Username, req.Msg.Email, req.Msg.Password, req.Msg.FullName, role)
	if err != nil {
...
func (h *UserHandler) ListUsers(
	...
	for _, u := range users {
		protoUsers = append(protoUsers, domainToProto(u))
	}
